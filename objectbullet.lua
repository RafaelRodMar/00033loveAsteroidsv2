...
function objectbullet:update(dt)
    self.velx = math.cos(math.rad(self.angle - 90)) * 6
    self.vely = math.sin(math.rad(self.angle - 90)) * 6

    self.posx = self.posx + self.velx * dt * 50
    self.posy = self.posy + self.vely * dt * 50
